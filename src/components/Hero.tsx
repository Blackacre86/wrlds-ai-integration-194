...
const Hero = () => {
  try {
    ...
    console.log('[Hero] Hero content loaded:', heroContent);
      ...
      <section id="hero" className="relative h-[70vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 w-full h-full">
          <video
            ...
            onError={(e) => console.error('[Hero] Video loading error:', e)}
          >
        ...
        <div className="relative z-10 text-center text-white px-4 max-w-4xl mx-auto animate-fade-in">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-fade-in animation-delay-400">
            ...
            <a 
              ...
              onClick={() => console.log('[Hero] Phone link clicked:', ctaPhone)}
            >
    ...
    console.error('[Hero] Error rendering Hero component:', error);
    return (
      <section id="hero" className="relative h-[70vh] flex items-center justify-center overflow-hidden bg-gray-900">
