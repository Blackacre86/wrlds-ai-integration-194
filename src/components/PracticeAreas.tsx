...
const PracticeAreas = () => {
  ...
  return (
    <section id="practice-areas" className="relative bg-white overflow-hidden py-10 md:py-[50px] w-full">
      <div className="w-full px-4 sm:px-6 lg:px-8" ref={practiceAreasRef}> 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-12">
          {practiceAreas.map((area, index) => (
            <div 
              key={index} 
              className="practice-area-item rounded-xl overflow-hidden transform transition-all duration-500 relative shadow-lg hover:-translate-y-1 h-[280px]"
              style={{
              ...
              <div className="relative z-10 flex flex-col justify-between p-6 h-full">
                <div>
                  <div className={cn(
                    ...
                    <div className={`transform transition-transform duration-300 ${hoveredArea === index ? 'rotate-12' : ''}`}>
                      {area.icon}
                    </div>
                  </div>
