              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
                <div className="backdrop-blur-md bg-blue-50/50 border border-blue-100 rounded-xl p-6 flex flex-col items-center text-center hover:shadow-lg transition-all">
                  ...
                  <p className="text-gray-700">
                    Our proprietary AI tools and LLMs examine every case aspect, identifying patterns and weaknesses
                    in prosecutorial arguments that traditional methods might overlook.
                  </p>
                </div>
                ...
                <div className="backdrop-blur-md bg-blue-50/50 border border-blue-100 rounded-xl p-6 flex flex-col items-center text-center hover:shadow-lg transition-all">
                  ...
                  <p className="text-gray-700">
                    Our AI rapidly analyzes legal databases and case precedents, ensuring accurate and current legal arguments
                    while allowing more personalized time for strategizing your case.
                  </p>
                </div>
                ...
                <div className="backdrop-blur-md bg-blue-50/50 border border-blue-100 rounded-xl p-6 flex flex-col items-center text-center hover:shadow-lg transition-all">
                  ...
                  <p className="text-gray-700">
                    We present evidence in compelling formats, such as visual simulations and interactive presentations,
