  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      <Helmet>
        ...
        <meta name="description" content="Learn about Attorney Joe Brava, founder of Summit Law. Former prosecutor with 5+ years experience now providing expert criminal defense representation in Massachusetts." />
        <meta name="keywords" content="Joe Brava attorney, former prosecutor, criminal defense lawyer Massachusetts, Summit Law, experienced criminal attorney" />
        <meta property="og:title" content="About Attorney Joe Brava | Summit Law Criminal Defense" />
        <meta property="og:description" content="Learn about Attorney Joe Brava, founder of Summit Law. Former prosecutor with 5+ years experience now providing expert criminal defense representation in Massachusetts." />
